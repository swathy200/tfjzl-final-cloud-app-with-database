...
# Updated to import Question, Choice, and Submission
...
def submit(request, course_id):
    ...
    # Use the helper function to get selected choice IDs
...
# Exam result view to calculate score and render results
